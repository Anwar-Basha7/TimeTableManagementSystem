...
<div>
    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="3" cellspacing="1" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">9:00-9:55</td>
                <td style="text-align:center">9:55-10:50</td>
                <td style="text-align:center">11:05-12:00</td>
                <td style="text-align:center">12:00-12:55</td>
                <td style="text-align:center">12:55-1:45</td>
                <td style="text-align:center">1:45-2:40</td>
                <td style="text-align:center">2:40-4:30</td>
...
<div class="text-center">
    <button onclick="window.print();" class="btn btn-primary" id="print-btn">SAVE AS PDF</button>
</div>
<div id="footer123">
    Generated by MSRIT Students
</div>
<!--HOME SECTION END-->
