...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div>
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, Department of CSE</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/msrit.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/msrit2.jpg" alt="Chania">
        </div>
        ...
        <div class="item">
            <img src="assets/img/msrit.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="7"> IV Year ( Semester VII )</option>
            <option value="8"> IV Year ( Semester VIII )</option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/Sushma.jpg" class="img-rounded"/>
                    <h3 align="center">Dr. Shushma B</h3>
                    <hr/>
                    <h4 align="center">Assistant Professor<br/>Department of CSE</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. Anita kanavalli</h3>
                    <hr/>
                    <h4 align="center">HOD<br/> Department of CSE</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/ganesh.jpg" class="img-rounded"/>
                    <h3 align="center">Dr. Ganeshayya shidaganti</h3>
                    <hr/>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said Anywhere</h4>
                <h4><strong>Call:</strong> 8431270793,9448725708,9535669663 </h4>
                <h4><strong>Email: </strong>1ms22cs403@msrit.edu,1ms22cs409@msrit.edu,1ms22cs411@msrit.edu</h4>
            </div>
